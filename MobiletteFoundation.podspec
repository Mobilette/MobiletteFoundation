Pod::Spec.new do |s|
	...
	s.source_files	= "MBSegueHandler/Source/*.{swift}", "MBRouterProtocol/Source/*.{swift}", "MBOAuthCredential/Source/*.{swift}", "MBError/Source/*.{swift}", "MBConfigurationHelper/Source/*.{swift}"
